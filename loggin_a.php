...
<head>
    ...
    <title>Connexion Admin - Justifly</title>
...
<body>
    ...
    <div class="login-container">
        ...
        <div class="logo-section">
            ...
            <p class="text-secondary">Connexion Admin</p>
        </div>
        ...
        <div class="user-types">
            <a href="student_login.php" class="user-type">
                <i class="fas fa-user-graduate"></i>
                <span>Étudiant</span>
            </a>
            <a href="teacher_login.php" class="user-type">
                <i class="fas fa-chalkboard-teacher"></i>
                <span>Enseignant</span>
            </a>
            <a href="admin_login.php" class="user-type active">
        ...
        loginForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    errorMessage.innerHTML = `<i class="fas fa-exclamation-circle mr-2"></i>${result.message}`;
                }
            } catch (error) {
                // Show error message
                errorMessage.style.display = 'block';
                errorMessage.innerHTML = `<i class="fas fa-exclamation-circle mr-2"></i>Une erreur s'est produite. Veuillez réessayer.`;
                btnText.style.display = 'block';
                loading.style.display = 'none';
                submitBtn.disabled = false;
            }
